...
const Nav = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("p", { className: "brand" }, "digant", /*#__PURE__*/

    React.createElement("strong", null, "sharma")), /*#__PURE__*/
...
const About = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("h4", { className: "subtitle" }, "My name is Digant Sharma."), /*#__PURE__*/
    React.createElement("p", null, "I am a web developer and UX designer based in the India at north of the beautiful Asia."), /*#__PURE__*/


    React.createElement("p", null, "I really enjoy solving problems as well as making things pretty and easy to use. I can't stop learning new things; the more, the better.I also love playing football, a hobby. I have a passion for rice with milk!")), /*#__PURE__*/
    ...
    React.createElement("p", null, "For the front-end I usually work with Javascript, either standalone or including popular frameworks like ReactJS. I also make the web pretty by using CSS and, whenever needed, any of their friends: Bootstrap, etc."), /*#__PURE__*/


    React.createElement("p", null, "For the back-end I also work with Javascript (NodeJS, Express, MongoDB, etc). But, of course, whenever the project requires Django, I do Django as well.")), /*#__PURE__*/



    React.createElement("div", { className: "desc" }, /*#__PURE__*/
    React.createElement("h4", { className: "subtitle" }, "Also a designer."), /*#__PURE__*/
    React.createElement("p", null, "I feel comfortable working with many frontend products like Angular, etc."), /*#__PURE__*/
...
const Projects = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("u", null, "most"), " of the projects I've been worked on.")), /*#__PURE__*/
    ...
    React.createElement(Project, {
      ...
      repo: "https://github.com/digantsharma1998/calcultor" }, /*#__PURE__*/
...
const Contact = props => {
  return /*#__PURE__*/(
    ...
    '', /*#__PURE__*/
    React.createElement("span", { className: "mail" }, "sharmadigant1998", /*#__PURE__*/
...
const Footer = props => {
  return /*#__PURE__*/(
    ...
    React.createElement("p", null, "\xA9 ", new Date().getFullYear(), " Digant Sharma."), /*#__PURE__*/
    React.createElement(SocialLinks, null))));
...
const SocialLinks = props => {
  return /*#__PURE__*/(
    ...
    ' ', /*#__PURE__*/
    React.createElement("i", { className: "fab fa-leetcode" })), /*#__PURE__*/
    ...
    ' ', /*#__PURE__*/
    React.createElement("i", { className: "fab fa-hackerrank" })), /*#__PURE__*/
